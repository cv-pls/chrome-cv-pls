...
(function() {
  ...
  // Settings accessors
  pluginSettings = new CvPlsHelper.chrome.ContentSettingsDataAccessor(new CvPlsHelper.chrome.SettingsDataStore(), CvPlsHelper.chrome.DefaultSettings);

  // Vote request processing
  audioPlayer = new CvPlsHelper.AudioPlayer(document, 'http://or.cdn.sstatic.net/chat/so.mp3');
  desktopNotificationDispatcher = new CvPlsHelper.chrome.DesktopNotificationDispatcher();
